...
<body>
    ...
    <div class="container">
        <header class="text-dark p-3 text-center">
            <h1 >Customers Shop Review</h1><br>
               </header> 
               <form method="post">
        <div class="col-md-6 offset-md-3 text-center">
            <div class="input-group">
              <input type="text" name="searchTerm" class="form-control border border-primary border-rounded" placeholder="Enter Shop Name" ><br>
    ...
    <table class="table table-borderless text-center">
        ...
        <?php 
                  if (isset($_POST['searchButton'])) {
                    ...
                    $query = "SELECT * FROM review WHERE shopname LIKE '%$key%'";
                }
                else{
...
{ 
  ?>
          <tr >
           ...
           <td> 
           <a href="mailto:<?php echo $email; ?>" class="btn btn-info btn-lg">Reply</a> 
          </tr>
          <?php } ?> 
        </tbody>
      </table>
