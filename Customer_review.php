        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center">
                    <p>FEEDBACK</p>
                    <h2>Feedback On The Workshop</h2>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="contact-form">
                            ...
                            <form method="post">
                                ...
                                <div class="control-group">
                                    <input type="text" class="form-control" id="email" name="shopname"  placeholder="Workshop Name" required />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="control-group">
...
$message = mysqli_real_escape_string($conn, $_POST['message']);
  $sql = "INSERT INTO review (name,email,shopname,message) VALUES ('$name','$email','$shopname','$message')";
