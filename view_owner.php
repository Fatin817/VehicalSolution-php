    ...
    <div class="container">
        ...
        <div class="col-md-6 offset-md-3 text-center">
            <div class="input-group">
              <input type="text" name="searchTerm" class="form-control border border-primary border-rounded" placeholder="Enter the Owner NID" ><br>
    ...
    <table class="table table-borderless text-center">
        ...
        <?php 
                  if (isset($_POST['searchButton'])) {
                    ...
                    $query = "SELECT * FROM owner WHERE ownerNID LIKE '%$key%'";
                }
                else{
...
{ 
  ?>
          <tr >
            ...
            <td><?php echo $result['shopaddress'];?></td>
            <td><?php echo $result['ownername'];?></td>
            <td><?php echo $result['ownerNID'];?></td>
            <td><?php echo $result['status'];?></td>
           <td> 
           <a href="owner_edit.php?ownerNID=<?php echo $result['ownerNID']; ?>"class="btn btn-success btn-lg mr-2 mb-1 ">View</a> 
           <a href="view_owner.php?ownerNID=<?php echo $result['ownerNID']; ?>"class="btn btn-danger btn-lg">Delete</a> 
          </tr>
          <?php } ?> 
        </tbody>
      </table>
...
if(isset($_GET['ownerNID'])) {
    ...
    if(isset($id)) {
      ...
      $sql = "DELETE FROM owner WHERE ownerNID = '$id'";
      if(mysqli_query($conn, $sql)) {
        ...
        echo '<script>
                Swal.fire({
                  ...
                  window.location.href = "view_owner.php";
                });
              </script>';
      }
