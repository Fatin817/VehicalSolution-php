    ...
    <div class="container">
        ...
        <div class="col-md-6 offset-md-3 text-center">
            <div class="input-group">
              <input type="text" name="searchTerm" class="form-control border border-primary border-rounded" placeholder="Enter your area" ><br>
    ...
    <table class="table table-borderless text-center">
        ...
        <?php 
                  if (isset($_POST['searchButton'])) {
                    ...
                    $query = "SELECT * FROM owner WHERE shopaddress LIKE '%$key%'";
                }
                else{
...
{ 
  ?>
          <tr >
           ...
           <td> 
           <a href="customer_search_result.php?ownerNID=<?php echo $result['ownerNID']; ?>"class="btn btn-success btn-lg mr-2 mb-1">View</a> 
           <a href="customer_see_review.php?ownerNID=<?php echo $result['ownerNID']; ?>"class="btn btn-warning btn-lg mr-2 ">Review</a> 
          </tr>
          <?php } ?> 
        </tbody>
      </table>
