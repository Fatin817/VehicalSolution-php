...
<html lang="en">
    ...
    <body>
        ...
        <!-- Top Bar End -->
        <?php 
$ownerNID = $_SESSION['ownerNID'];
$query=mysqli_query($conn,"select * from owner where ownerNID='$ownerNID'");
                ...
                <div class="owl-carousel">
                    <div class="carousel-item">
                        <div class="carousel-img">
                            <img src="66.jpg" alt="Image">
                        </div>
                        <div class="carousel-text">
                            <h3>Vehical Solution</h3>
                            <h1>Workshop Profile</h1>
                            <a class="btn btn-custom" href="ownerprofile.php">Profile</a>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-text">
                            ...
                            <a class="btn btn-custom" href="see_review.php">Feedback</a>
